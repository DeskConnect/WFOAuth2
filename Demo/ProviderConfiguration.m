...
+ (NSArray<ProviderConfiguration *> *)allConfigurations {
    ...
    dispatch_once(&onceToken, ^{
        allConfigurations = @[
            [self newWithClass:[WFBoxOAuth2SessionManager class] clientID:@"4yjzhklb7ks1fvv9akvgeb69dwu0fwza" clientSecret:@"e6KNbpoSTmy5Lqw2yVdEAflIhCdb93TU" scopes:nil redirectURI:[NSURL URLWithString:@"wfoauth2://callback"]],
            [self newWithClass:[WFDropboxOAuth2SessionManager class] clientID:@"k3869owh4bj3zbt" clientSecret:@"49jy1mdm6o30w3t" scopes:nil redirectURI:nil],
            [self newWithClass:[WFGoogleOAuth2SessionManager class] clientID:@"266399808145-3avt9dudaqe71j6lr8haqigudqi91lf5.apps.googleusercontent.com" clientSecret:nil scopes:@[WFGoogleOpenIDScope, WFGoogleProfileScope, WFGoogleEmailScope] redirectURI:[NSURL URLWithString:@"com.googleusercontent.apps.266399808145-3avt9dudaqe71j6lr8haqigudqi91lf5:/callback"]],
            ...
            [self newWithClass:[WFUberOAuth2SessionManager class] clientID:@"FVZC8i9VfAn2DIi0TdBG0-I5T7RcU3_j" clientSecret:nil scopes:@[WFUberUserProfileScope] redirectURI:[NSURL URLWithString:@"wfoauth2://callback"]],
            [self newWithClass:[WFVenmoOAuth2SessionManager class] clientID:nil clientSecret:nil scopes:@[WFVenmoMakePaymentsScope, WFVenmoProfileScope] redirectURI:nil],
