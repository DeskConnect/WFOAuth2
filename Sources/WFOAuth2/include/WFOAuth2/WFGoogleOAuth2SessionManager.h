...
WF_EXTERN WFGoogleOAuth2Scope const WFGoogleNativeRedirectURIString;
WF_EXTERN WFGoogleOAuth2Scope const WFGoogleEmailScope;
WF_EXTERN WFGoogleOAuth2Scope const WFGoogleProfileScope;
